...
public class BoardDao {
	...
	public BoardVO getBoardSelectOne(BoardVO bvo) {
		return sql.selectOne("board.getBoardSelectOne", bvo);
	}
	
	public int setBoardModify(BoardVO bv) {
		return sql.update("board.setBoardModify", bv);
