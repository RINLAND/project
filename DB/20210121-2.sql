...
--
-- Table structure for table `gat_article_aaas`
--

DROP TABLE IF EXISTS `gat_article_aaas`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `gat_article_aaas` (
...
--
-- Dumping data for table `gat_article_aaas`
--

LOCK TABLES `gat_article_aaas` WRITE;
/*!40000 ALTER TABLE `gat_article_aaas` DISABLE KEYS */;
/*!40000 ALTER TABLE `gat_article_aaas` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `gat_article_fghj`
--

DROP TABLE IF EXISTS `gat_article_fghj`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `gat_article_fghj` (
  `aid` int NOT NULL AUTO_INCREMENT,
  `division` char(1) DEFAULT NULL,
  `subject` varchar(300) NOT NULL,
  `writer` varchar(20) NOT NULL,
...
--
-- Dumping data for table `gat_article_fghj`
--

LOCK TABLES `gat_article_fghj` WRITE;
/*!40000 ALTER TABLE `gat_article_fghj` DISABLE KEYS */;
/*!40000 ALTER TABLE `gat_article_fghj` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `gat_article_iuuioiu`
--

DROP TABLE IF EXISTS `gat_article_iuuioiu`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `gat_article_iuuioiu` (
  `aid` int NOT NULL AUTO_INCREMENT,
  `division` char(1) DEFAULT NULL,
  `subject` varchar(300) NOT NULL,
  `writer` varchar(20) NOT NULL,
...
--
-- Dumping data for table `gat_article_iuuioiu`
--

LOCK TABLES `gat_article_iuuioiu` WRITE;
/*!40000 ALTER TABLE `gat_article_iuuioiu` DISABLE KEYS */;
/*!40000 ALTER TABLE `gat_article_iuuioiu` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `gat_article_uiu`
--

DROP TABLE IF EXISTS `gat_article_uiu`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `gat_article_uiu` (
  `aid` int NOT NULL AUTO_INCREMENT,
  `division` char(1) DEFAULT NULL,
  `subject` varchar(300) NOT NULL,
  `writer` varchar(20) NOT NULL,
...
--
-- Dumping data for table `gat_article_uiu`
--

LOCK TABLES `gat_article_uiu` WRITE;
/*!40000 ALTER TABLE `gat_article_uiu` DISABLE KEYS */;
/*!40000 ALTER TABLE `gat_article_uiu` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `gat_article_yyyu`
--

DROP TABLE IF EXISTS `gat_article_yyyu`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `gat_article_yyyu` (
  `aid` int NOT NULL AUTO_INCREMENT,
  `division` char(1) DEFAULT NULL,
  `subject` varchar(300) NOT NULL,
  `writer` varchar(20) NOT NULL,
...
--
-- Dumping data for table `gat_article_yyyu`
--

LOCK TABLES `gat_article_yyyu` WRITE;
/*!40000 ALTER TABLE `gat_article_yyyu` DISABLE KEYS */;
/*!40000 ALTER TABLE `gat_article_yyyu` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `gat_comment_aaas`
--

DROP TABLE IF EXISTS `gat_comment_aaas`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `gat_comment_aaas` (
...
--
-- Dumping data for table `gat_comment_aaas`
--

LOCK TABLES `gat_comment_aaas` WRITE;
/*!40000 ALTER TABLE `gat_comment_aaas` DISABLE KEYS */;
/*!40000 ALTER TABLE `gat_comment_aaas` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `gat_comment_fghj`
--

DROP TABLE IF EXISTS `gat_comment_fghj`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `gat_comment_fghj` (
  `cid` int NOT NULL AUTO_INCREMENT,
  `aid` int NOT NULL,
  `comment` text,
  `who` varchar(20) DEFAULT NULL,
...
--
-- Dumping data for table `gat_comment_fghj`
--

LOCK TABLES `gat_comment_fghj` WRITE;
/*!40000 ALTER TABLE `gat_comment_fghj` DISABLE KEYS */;
/*!40000 ALTER TABLE `gat_comment_fghj` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `gat_comment_iuuioiu`
--

DROP TABLE IF EXISTS `gat_comment_iuuioiu`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `gat_comment_iuuioiu` (
  `cid` int NOT NULL AUTO_INCREMENT,
  `aid` int NOT NULL,
  `comment` text,
  `who` varchar(20) DEFAULT NULL,
...
--
-- Dumping data for table `gat_comment_iuuioiu`
--

LOCK TABLES `gat_comment_iuuioiu` WRITE;
/*!40000 ALTER TABLE `gat_comment_iuuioiu` DISABLE KEYS */;
/*!40000 ALTER TABLE `gat_comment_iuuioiu` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `gat_comment_uiu`
--

DROP TABLE IF EXISTS `gat_comment_uiu`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `gat_comment_uiu` (
  `cid` int NOT NULL AUTO_INCREMENT,
  `aid` int NOT NULL,
  `comment` text,
  `who` varchar(20) DEFAULT NULL,
...
--
-- Dumping data for table `gat_comment_uiu`
--

LOCK TABLES `gat_comment_uiu` WRITE;
/*!40000 ALTER TABLE `gat_comment_uiu` DISABLE KEYS */;
/*!40000 ALTER TABLE `gat_comment_uiu` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `gat_comment_yyyu`
--

DROP TABLE IF EXISTS `gat_comment_yyyu`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `gat_comment_yyyu` (
  `cid` int NOT NULL AUTO_INCREMENT,
  `aid` int NOT NULL,
  `comment` text,
  `who` varchar(20) DEFAULT NULL,
...
--
-- Dumping data for table `gat_comment_yyyu`
--

LOCK TABLES `gat_comment_yyyu` WRITE;
/*!40000 ALTER TABLE `gat_comment_yyyu` DISABLE KEYS */;
/*!40000 ALTER TABLE `gat_comment_yyyu` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `grp_freeboard` VALUES (1,'100','yyyu','red','','tttt','1','1','1','1','100','yes','2021-01-21','ui8i8');
...
INSERT INTO `grp_teamboard` VALUES (11,'100','aaas','red','','aaa','1','1','1','1','100','yes','2021-01-21','aaasd');
...
-- Dump completed on 2021-01-21 22:28:42
