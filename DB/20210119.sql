...
CREATE TABLE `grp_board` (
  ...
  `boardReference` varchar(5) NOT NULL,
...
INSERT INTO `grp_board` VALUES (1,'100','ggg','skyblue','','fff','1','1','1','1','100','no','2021-01-19','erty');
...
CREATE TABLE `grp_calendar` (
  ...
  `calContent` varchar(20) NOT NULL,
  `enpNum` varchar(10) NOT NULL,
  PRIMARY KEY (`cal_id`)
...
INSERT INTO `grp_system` VALUES ('VV ENTERTAMENT COMPANY','GROUP SYSTEM','CYJ','051-152-4567','VV ENT.good.co.kr','good alright reserved','Korea. Seoul','Have A Good Day','BEST ENTERTAMENT','BEST PEOPLE',2);
...
-- Dump completed on 2021-01-19 17:56:30
