...
CREATE TABLE `grp_freeboard` (
  ...
  `fTeam` varchar(20) NOT NULL,
  `fCode` varchar(20) NOT NULL,
  `fColor` varchar(20) NOT NULL,
  `fMaker` varchar(20) NOT NULL,
  `fTitle` varchar(200) NOT NULL,
  `fRead` char(1) DEFAULT '1',
  `fWrite` char(1) DEFAULT '1',
  `fReply` char(1) DEFAULT '1',
  `fDown` char(1) DEFAULT '1',
  `fType` varchar(20) DEFAULT '1',
  `fReference` varchar(20) DEFAULT 'Y',
...
CREATE TABLE `grp_notice` (
  ...
  `nTeam` varchar(20) NOT NULL,
  `nCode` varchar(20) NOT NULL,
  `nColor` varchar(20) NOT NULL,
  `nMaker` varchar(20) NOT NULL,
  `nTitle` varchar(200) NOT NULL,
  `nRead` char(1) DEFAULT '1',
  `nWrite` char(1) DEFAULT '1',
  `nReply` char(1) DEFAULT '1',
  `nDown` char(1) DEFAULT '1',
  `nType` varchar(20) DEFAULT '1',
  `nReference` varchar(20) DEFAULT 'Y',
  `nRegdate` date DEFAULT NULL,
  `nDetail` varchar(100) NOT NULL,
  PRIMARY KEY (`nID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-01-21 13:53:04
