						...
						<!-- Nav -->
							<nav id="nav">
								<ul>
									...
									<li><a class="strong"><span>ARTIST</a></span>
										<ul>
											<li><a href="#">MUSICIANS</a></li>
											<li><a href="#">ACTORS</a></li>
											<li><a href="#">ENTERTASINERS</a></li>
											<li><a href="#">MODELS</a></li>
											<li><a href="#">ATHLETES</a></li>
										</ul>
									</li>
									<li><a class="strong"><span>AUDITION</a></span>
										<ul>
											<li><a href="#">ONLINE</a></li>
											<li><a href="#">OFFLINE</a></li>
											<li><a href="#">NOTICE</a></li>
											<li><a href="#">MY AUDITION</a></li>
										</ul>						
									</li>
									<li><a class="strong"><span>CSR</a></span>
										<ul>
											<li><a href="#">ABOUT</a></li>
												...
												<li>
													...
													<!-- Highlight -->
														<article class="box highlight">
															...
															<ul class="actions">
																<li><a href="#" class="button icon solid fa-file">Read More</a></li>
															</ul>
														</article>
