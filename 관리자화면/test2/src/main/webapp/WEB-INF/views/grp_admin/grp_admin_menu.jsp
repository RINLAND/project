	...
	<!-- Sidebar -->
		<div id="sidebar">
			...
			<nav id="menu">
				...
				<ul>
					<li><span class="opener"><a
								href="${pageContext.request.contextPath }/grp_notice.html">공지사항</a></span>
						<ul>
					...
					<li>
						<span class="opener"><a
								href="${pageContext.request.contextPath }/grp_system.html">시스템</a></span>
						<ul>
			...
			<footer id="footer">
				<p class="copyright">&copy; Untitled. All rights reserved. Demo Images: <a
						href="${pageContext.request.contextPath }https://unsplash.com">Unsplash</a>. Design: <a
						href="${pageContext.request.contextPath }https://html5up.net">HTML5
						UP</a>.</p>
			</footer>
		</div>
