...
<!------------------------------------------------ 게시판생성--------------------------------------- -->
				<div class="board-wrap bg-white ">
					<form method="POST" id="frm" action="${pageContext.request.contextPath }/freeboard/grp_teamboard_modify?boardCode=${board.boardCode }">
						<table>
							<tr>
						...
						<div class="btn-grp center m-t5">
                        	...
                        	<button type="button" onclick="location.href='${pageContext.request.contextPath }/freeboard/grp_teamboard_list'"  class="btn-red">목록</button>
						</div>
					</form>
					</div>
</body>
...
<script>
	$(function(){
		$("#btn").click(function(){
			...
			$.ajax({
				url : "${pageContext.request.contextPath }/freeboard/grp_teamboard_insert",
				type : "post",
				data : $("#frm").serialize(),
				success : function(resData){
...
<script>
	function boardModify(boardCode){
		...
		if(confirm(msg)){  //확인 클릭
			...
			$.ajax({
				url : "${pageContext.request.contextPath }/freeboard/grp_teamboard_modify",
				type : "post",
				data : formData,
				success : function(resData){
					if(resData == "success"){
