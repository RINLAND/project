		...
		<div id="main">
			<div class="inner">
				...
				<!-- Content -->
					...
					<div class="main ">
						<div class="main-top ">
							<h4 class="m-b20">공지게시판 > 부서게시판목록</h4>
 					...
 					<div class="board-list">
                            <table>
                                ...
                                <tr class="center font14 weight700">
                                    ...
                                    <td>
                                        <a href="${pageContext.request.contextPath }/notice/grp_article_list?boardCode=${board.boardCode }" 
                                        target="_blank" class="">
...
function loadPost(){
	$.ajax({
		url : "${pageContext.request.contextPath }/notice/grp_get_post",
		type : "post",
		data : "",
...
<script>
	$(function(){
		$("#btn").click(function(){
			...
			$.ajax({
				url : "${pageContext.request.contextPath }/notice/grp_notice_insert",
				type : "post",
				data : $("#frm").serialize(),
				success : function(resData){
...
<script>
	function boardDel(boardCode){
		...
		if(confirm(msg)){  //확인 클릭
			...
			$.ajax({
				url : "${pageContext.request.contextPath }/notice/grp_notice_delete",
				type : "post",
				data : formData,
				success : function(resData){
					if(resData == "success"){
